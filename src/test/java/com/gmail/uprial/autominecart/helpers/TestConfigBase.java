...
import com.gmail.uprial.autominecart.AutoMinecartConfig;
...
public abstract class TestConfigBase {
    ...
    protected static AutoMinecartConfig loadConfig(String... contents) throws InvalidConfigurationException, InvalidConfigException {
        return loadConfig(getCustomLogger(), contents);
    }

    protected static AutoMinecartConfig loadConfig(TestCustomLogger testCustomLogger, String... contents) throws InvalidConfigurationException, InvalidConfigException {
        return AutoMinecartConfig.getFromConfig(getPreparedConfig(contents), testCustomLogger);
    }
