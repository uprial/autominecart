...
public class AutoMinecartConfigTest extends TestConfigBase {
    @Rule
    ...
    public void testEmptyDebug() throws Exception {
        ...
        AutoMinecartConfig.isDebugMode(getPreparedConfig(""), getDebugFearingCustomLogger());
    }

    @Test
    public void testNormalDebug() throws Exception {
        assertTrue(AutoMinecartConfig.isDebugMode(getPreparedConfig("debug: true"), getDebugFearingCustomLogger()));
    }
